        ...
        function getList(pageNum, reset) {
            ...
            fetch('${pageContext.request.contextPath}/reply/getList/' + bno + '/' + pageNum)
                ...
                .then(data => {                
                    ...
                    //응답 데이터의 길이가 0과 같거나 더 작으면 함수를 종
                    if(reaaplyList.legnth)
                    ...
                    for(let i=0; i<replyList.length; i++) {
                        ...
                        <div class='reply-content'>
                            <div class='reply-group'>
                                ...
                                <small class='left'>` + (replyList[i].updateDate != null ? parseTime(replyList[i].updateDate) + '(수정됨)') : parseTime(replyList[i].reply})+ `</small>

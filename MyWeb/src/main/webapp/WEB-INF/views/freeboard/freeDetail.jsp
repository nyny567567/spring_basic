            ...
            <div class="row">
                <div class="col-xs-12 col-md-9 write-wrap">
                        ...
                        <form action="<c:url value='/freeboard/modify' />" method="post">
                            ...
                            <button type="button" class="btn btn-dark" onclick="location.href='${pageContext.request.contextPath}/freeboard/freeList?pageNum=${p.pageNum}&cpp=${p.cpp}&keyword=${p.keyword}$content=${p.content}'">목록</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        window.onload = function() {
            ...
            document.getElementById('replyRegist').onclick = () => {
                ...
                fetch('${pageContext.request.cntextPath}/reply/regist, 
                .then(res => res.text())
                .then(data => {
            ...
            //페이지를 리셋해서 새롭게 그려낼 것인지, 누적해서 쌓을 것인지의 여부를 판단 )
             function getList(pageNum, reset) {
                ...
                //get방식으로 댓글 목록을 쵸청(비동기)
                fetch('${pageContext.request.contextPath/}/reply/getList/''            }
